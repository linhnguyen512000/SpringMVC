...
<c:if test="${list.size() != 0}">
	<h2 class="tt-title-subpages noborder"  style="margin-top: 20px;">
      KẾT QUẢ TÌM KIẾM CHO "<span >${value}</span>" 
    </h2>
...
<c:if test="${list.size() == 0}">
	<div class="container-indent nomargin">
		<div class="tt-empty-search"  style="padding-top: 10px;">
			<span class="tt-icon icon-f-85"></span>
			<h1 class="tt-title">KHÔNG CÓ SẢN PHẨM.</h1>
			<p>Kết quả tìm kiếm cho "<span class="tt-base-dark-color">${value}</span>"</p>
		</div>
	</div>
	</c:if>
</div>
