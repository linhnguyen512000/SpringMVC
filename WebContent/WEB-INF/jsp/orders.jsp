...
<th:block th:fragment="content">
	<div class="kt-portlet kt-portlet--mobile">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/admin/addProduct"  enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-6">
                          ...
                          <input type="text" class="form-control"
                                 id="addname" name="color" required>
                        </div>
                        <div class="col-6">
                          <label for="addcost"
                                 class="col-form-label">Size: </label>
                          <input type="number" class="form-control"
                                 id="addcost" name="size" required>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6">
		...
		<div class="kt-portlet__body">
					<form method="post" action="${pageContext.request.contextPath}/admin/searchOrders">
					<div class="row">
						<div class="col-6">
                          <label for="addname"
                                 class="col-form-label">Name:</label>
						...
						<div class="col-6">
                          ...
                          <select class="form-control" name="name" aria-label="Default select example" required>
				                    	...
				                    	<option value="delieryStatus">Delivery Status</option>
			              </select>
                        </div>
                        <div class="modal-footer">
			...
			<table id="datatablesSimple" >
				...
				<c:set var="num" value="${num+1}"/>
					<tr>
						...
						<form method="post" action="${pageContext.request.contextPath}/admin/orderDetail">
							<input type="hidden" class="form-control" id="id" name="id" value="${order.id}">
							<button type="submit" style="width: 80px" class="btn btn-primary" data-bs-toggle="modal">
		                      Detail
		                    </button>
		                    </form>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <label for="addname"
                                 class="col-form-label">Color: </label>
                          <input type="text" class="form-control"
                                 id="addname" name="color" value="${product.color}" required>
                        </div>
                        <div class="col-6">
                          <label for="addcost"
                                 class="col-form-label">Size: </label>
                          <input type="number" class="form-control"
                                 id="addcost" name="size" required value="${product.size}">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6">
