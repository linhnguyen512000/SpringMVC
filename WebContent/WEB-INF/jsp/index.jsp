...
<head>
	<meta charset="utf-8">
	<title>TopShoe Store - Trang chủ</title>
	<meta name="keywords" content="TopShoe Store">
	<meta name="description" content="TopShoe Store">
						...
						<div class="tt-desctop-menu">
							<nav>
								<ul>
									...
									<li class="dropdown megamenu"><a href="/asm3/all">SẢN PHẨM</a></li>
		...
		<div class="container-fluid">
			<div class="tt-slick-slider arrow-slick-main">
				<div class="tt-slick-main-item">
					...
					<div class="tt-description tt-point-h-c">
						<div class="tt-description-wrapper">
							...
							<div class="tt-title-large"><span class="tt-white-color">TopShoe<br></span></div>
				...
				<div class="tt-slick-main-item">
					...
					<div class="tt-description tt-point-h-r">
						<div class="tt-description-wrapper">
							<div class="tt-title-small"><span class="tt-base-color">TopShoe</span></div>
							...
							<a href="/product-listing" class="tt-promo-box tt-one-child">
								...
								<div class="tt-description">
									<div class="tt-description-wrapper">
										...
										<div class="tt-title-large">TopShoe</div>
									</div>
								</div>
							</a>
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-4">
					<h6 class="tt-title-sub">SẢN PHẨM MỚI</h6>
...
<script src="${pageContext.request.contextPath}/external/instafeed/instafeed.min.js"></script>
<script src="${pageContext.request.contextPath}/external/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
<script src="${pageContext.request.contextPath}/external/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
