...
<th:block th:fragment="content">
	<div class="kt-portlet kt-portlet--mobile">
		...
		<h3>Đơn hàng ${order.id} - ${order.deliveryStatus }</h3>
		<c:set var="a" value="Chưa xét duyệt"/>
		<c:set var="b" value="Chờ giao hàng"/>
		<c:set var="c" value="Đang giao hàng"/>
		<c:set var="d" value="Đang giao hàng lần 2"/>
		<c:set var="e" value="Giao hàng thành công"/>
		<c:set var="f" value="Đã hủy"/>
					<c:if test="${!(order.deliveryStatus eq e) and !(order.deliveryStatus eq f)}">
					<form method="post" action="${pageContext.request.contextPath}/admin/cancelOrder">
					...
					<c:if test="${order.deliveryStatus eq a}">
					<form method="post" action="${pageContext.request.contextPath}/admin/acceptOrder">
						<input type="hidden" class="form-control" id="id" name="id" value="${order.id}">
                        <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">Duyệt đơn hàng này</button>
                      </div>
                      </form>
					</c:if>
					<c:if test="${order.deliveryStatus eq b}">
					<form method="post" action="${pageContext.request.contextPath}/admin/beginDelivery">
						<input type="hidden" class="form-control" id="id" name="id" value="${order.id}">
                        <div class="modal-footer">
					...
					<c:if test="${order.deliveryStatus eq c}">
					<form method="post" action="${pageContext.request.contextPath}/admin/successDelivery">
						<input type="hidden" class="form-control" id="id" name="id" value="${order.id}">
                        <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">Giao hàng thành công</button>
                      </div>
                      </form>
                      <form method="post" action="${pageContext.request.contextPath}/admin/failDelivery1">
						<input type="hidden" class="form-control" id="id" name="id" value="${order.id}">
                        <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">Giao thất bại, giao lần 2</button>
                      </div>
                      </form>
					</c:if>
					<c:if test="${order.deliveryStatus eq d}">
					<form method="post" action="${pageContext.request.contextPath}/admin/successDelivery">
						<input type="hidden" class="form-control" id="id" name="id" value="${order.id}">
                        <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">Giao hàng thành công</button>
                      ...
                      <form method="post" action="${pageContext.request.contextPath}/admin/failDelivery2">
						<input type="hidden" class="form-control" id="id" name="id" value="${order.id}">
                        <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">Giao hàng không thành công</button>
                      </div>
                      </form>
					</c:if>
		</div>
		...
		<div class="col-12 col-md-6">
					<div class="row">
						...
						<div class="col-7 col-md-8" >${order.consignee}</div>
					</div>
				</div>
				<div class="col-12 col-md-6">
					<div class="row">
						<div class="col-5 col-md-4 lbl_title">Số điện thoại:</div>
						<div class="col-7 col-md-8" >${order.consigneePhone}</div>
					</div>
				</div>
				<div class="col-12 col-md-6">
					<div class="row">
						<div class="col-5 col-md-4 lbl_title">Địa chỉ nhận hàng:</div>
						<div class="col-7 col-md-8" >${order.deliveryAddress}</div>
					</div>
				</div>
				<div class="col-12 col-md-6">
					<div class="row">
						<div class="col-5 col-md-4 lbl_title">Hình thức thanh toán:</div>
						<div class="col-7 col-md-8" >${order.paymentMethod}</div>
					</div>
				</div>
				<div class="col-12 col-md-6">
					<div class="row">
						<div class="col-5 col-md-4 lbl_title">Trạng thái thanh toán:</div>
						<div class="col-7 col-md-8" >${order.paymentStatus}</div>
					</div>
				</div>
				<div class="col-12 col-md-6">
					<div class="row">
						<div class="col-5 col-md-4 lbl_title">Trạng thái vận chuyển:</div>
						<div class="col-7 col-md-8" >${order.deliveryStatus}</div>
					</div>
				</div>
			<!--begin: Datatable -->
			...
			<table id="datatablesSimple" >
				...
				<c:set var="num" value="${num+1}"/>
					<tr>
						...
						<td>${orderDetail.product.price}  VND</td>
						<td>${orderDetail.quantity}</td>
						<td>${orderDetail.product.price * orderDetail.quantity}</td>
						<td>${orderDetail.product.versionName}</td>
