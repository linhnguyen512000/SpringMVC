...
<head>
	<title>TopShoe - Order Result</title>
	<meta charset="utf-8">
		...
		<div class="tt-page404">
			...
			<p>
				...
				<th:block th:if="${isSuccess}">
					Mã đơn hàng của bạn: <span class="order_id" >${orderNum}</span>
				</th:block>
			</p>

			<a href="${pageContext.request.contextPath}/myOrders" class="btn btn-show-detail">Xem đơn hàng của tôi</a>
		</div>
	</div>
</div>
